...
launcher="${launcher_dir}/onedrive-for-linux.desktop"
...
Version=1.0
Type=Application
Name=OneDrive for Linux - Install
Comment=Install and configure OneDrive synchronization
...
echo "Mở Applications và chọn: OneDrive for Linux - Install"
